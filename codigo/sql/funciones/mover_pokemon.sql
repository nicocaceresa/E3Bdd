...
BEGIN
    ...
    FOR tupla IN (SELECT * FROM pokemon) -- creamos la tabla usuarios, luego por cada tipo de tabla por cada usuario lo añadimos a la tabla con la información que corresponda
                                        -- hacerlo sin boton, solo desde la consola nomás.
    LOOP
